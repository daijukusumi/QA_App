...
public class AnswerSendActivity extends AppCompatActivity implements View.OnClickListener, DatabaseReference.CompletionListener {
    ...
    public void onClick(View v) {
        ...
        DatabaseReference answerRef = dataBaseReference.child(Const.ContentsPATH).child(mQuestion.getGenreNo()).child(mQuestion.getQuestionUid()).child(Const.AnswersPATH);
